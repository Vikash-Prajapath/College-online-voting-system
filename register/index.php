                         ...
                         <form method = "post" enctype = "multipart/form-data">
                                ...
                                <div class="form-heading">
                         		<center>Voter Registeration</center>
											...
											<div class="form-field">
												<label>Course<i>(enter initials only i.e BCA, BSc, BBA, Bcom..)</i></label><br/>
													<input class="form-control"  type = "text" name = "prog_study" placeholder="E.g BCA, BSc, BBA, Bcom" required="true">
											</div>
