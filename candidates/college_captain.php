    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <heading class="voters_heading">
                <center><h1>Registered College Captain Candidates</h1>
                    <center>
                        <select onchange = "page(this.value)">
                            <option disabled selected>Select Candidate Group</option>
                            <option disabled selected>College Captain</option>
                            <option value = "cultural_captain.php">Cultural Captain</option>
                            <option value = "sports_captain.php">Sports Captain</option>
                            <option value = "department_captain.php">Department Captain</option>
