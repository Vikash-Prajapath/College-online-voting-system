...
?>
		<script>
			alert( 'The Student ID you entered already exists in the database. Please enter a different ID.');
			window.location='current_students.php';
	</script>	
<?php
	}
	else{
			$conn->query("insert into ids(id_number, names, started) VALUES('$id_number', '$names')");
?>
	<script>
