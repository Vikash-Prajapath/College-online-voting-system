                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="activate_accounts.php?voter_id=<?php echo $voters_id; ?>" class="btn btn-danger btn-outline"><i>Activate</i></a>
                                            <a href="deactivate_accounts.php?voter_id=<?php echo $voters_id; ?>" class="btn btn-danger btn-outline"><i>Deactivate</i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
